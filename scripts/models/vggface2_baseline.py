#!/usr/bin/env python3
"""
TRANSFER LEARNING WITH VGGFACE2 - FIXED
...
# Use only convolutional + pooling layers (remove classifier)
...
print("="*80)
print("PHASE 1: Linear Probe (Freeze VGGFace2 backbone)")
print("="*80 + "\n")
...
print(f"✓ Phase 1 complete. Best AUC: {best_auc:.3f}\n")

# ========== PHASE 2: Fine-tune ==========
print("="*80)
print("PHASE 2: Fine-tune (Unfreeze last conv block)")
print("="*80 + "\n")

# Unfreeze last conv block
for param in model.feature_extractor[-4:].parameters():
...
print(f"✓ Phase 2 complete. Best AUC: {best_auc:.3f}\n")
...
results = {
    'VGGFace2 Transfer Learning': {
        ...
        'method': 'Transfer Learning (Two-phase)',
        'backbone': 'VGG-16 (face-pretrained)',
        'pretraining': '3.31M human face images (9,131 people)',
        'training_approach': 'Phase 1: Linear probe + Phase 2: Fine-tune'
    }
}
...
print("="*80)
print(f"\n🎯 VGGFace2 Transfer Learning Results:")
print(f"   Backbone: VGG-16 (face-pretrained)")
print(f"   Pretraining: 3.31M human faces (9,131 people)")
print(f"   Accuracy: {acc*100:.1f}%")
print(f"   Precision: {prec*100:.1f}%")
print(f"   Recall: {rec*100:.1f}%")
print(f"   F1-Score: {f1:.3f}")
